...
- простой авторизацией по bearer-токену;
...
- `POST /api/auth/login` - логин, выдаёт токен
- `GET /api/auth/me` - текущий пользователь

Для защищённых методов передаётся заголовок:
...
2. Войти одним из них и получить токен.
